...
<table border="1px" width="100%">
	<tr>
		<td width="20%">地点</td>
		<td width="80%">
		<input style="width:80%;"  name="eventLocation" value="${record.eventLocation}">
	</tr>
	<tr>
		<td width="20%">时间</td>
		<td width="80%">
			<input type="date" style="width:80%;"  name="eventTime" value="${record.eventTime}">
	</tr>
	<tr>
		<td width="20%">内容</td>
		<td width="80%">
		<textarea style="width:100%;height:400px"  name="recordText">${record.recordText}</textarea>
		</td>
	</tr>
	<tr>
